...
export class CryptoUtils {
  ...
  /**
   * Runs a comprehensive test of the crypto utilities
   * Tests key generation, signing, and verification
   * @returns CryptoTestResult with success status, results array, and optional error
   * @example
   * ```typescript
   ...
   * ```
   */
  static async runCryptoTest(): Promise<CryptoTestResult> {
